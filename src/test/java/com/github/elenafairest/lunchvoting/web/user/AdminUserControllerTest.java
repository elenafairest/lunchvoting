...
class AdminUserControllerTest extends AbstractControllerTest {
    ...
    private static final String URL_SLASH = AdminUserController.URL + '/';
    ...
    void get() throws Exception {
        perform(MockMvcRequestBuilders.get(URL_SLASH + UserTestData.ADMIN_ID))
    ...
    void getNotFound() throws Exception {
        perform(MockMvcRequestBuilders.get(URL_SLASH + UserTestData.NOT_FOUND))
                .andDo(print())
    ...
    void getByEmail() throws Exception {
        perform(MockMvcRequestBuilders.get(URL_SLASH + "by-email?email=" + UserTestData.admin.getEmail()))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(UserTestData.USER_MATCHER.contentJson(UserTestData.admin));
    }
    ...
    void delete() throws Exception {
        perform(MockMvcRequestBuilders.delete(URL_SLASH + UserTestData.USER_ID))
                .andDo(print())
    ...
    void deleteNotFound() throws Exception {
        perform(MockMvcRequestBuilders.delete(URL_SLASH + UserTestData.NOT_FOUND))
                .andDo(print())
    ...
    void enableNotFound() throws Exception {
        perform(MockMvcRequestBuilders.patch(URL_SLASH + UserTestData.NOT_FOUND)
                .param("enabled", "false")
    ...
    void getUnauthorized() throws Exception {
        perform(MockMvcRequestBuilders.get(AdminUserController.URL))
    ...
    void update() throws Exception {
        ...
        updated.setId(null);
        perform(MockMvcRequestBuilders.put(URL_SLASH + UserTestData.USER_ID)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    void createWithLocation() throws Exception {
        ...
        ResultActions action = perform(MockMvcRequestBuilders.post(AdminUserController.URL)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    void enable() throws Exception {
        perform(MockMvcRequestBuilders.patch(URL_SLASH + UserTestData.USER_ID)
                .param("enabled", "false")
                .contentType(MediaType.APPLICATION_JSON))
                .andDo(print())
                .andExpect(status().isNoContent());
    ...
    void createInvalid() throws Exception {
        ...
        perform(MockMvcRequestBuilders.post(AdminUserController.URL)
                .contentType(MediaType.APPLICATION_JSON)
