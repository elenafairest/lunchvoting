...
public class MenuItemTestData {
    ...
    public static final MenuItem menuItem15 = new MenuItem(MENU_ITEM1_ID + 14, "brokoli cream-soup", 150, LocalDate.now().minusDays(2));
    public static final MenuItem menuItem16 = new MenuItem(MENU_ITEM1_ID + 15, "meatball in tomato sauce", 300, LocalDate.now().minusDays(2));
    public static final MenuItem menuItem17 = new MenuItem(MENU_ITEM1_ID + 16, "potato salad", 150, LocalDate.now().minusDays(2));
    public static final List<MenuItem> menuItemsKakaoMama = List.of(menuItem15, menuItem16, menuItem17, menuItem9,
            menuItem8, menuItem10, menuItem2, menuItem3, menuItem1);
