...
VALUES ('pumpkin cream-soup', 150, '2022-11-08', 1),
       ...
       ('brokoli cream-soup', 150, CURRENT_DATE, 1),
       ('meatball in tomato sauce', 300, CURRENT_DATE, 1),
       ('potato salad', 150, CURRENT_DATE, 1),
